 ...
 * @author Admin
 */
public class Reader_ReturnJDialog extends javax.swing.JDialog {
    ...
    public Reader_ReturnJDialog(java.awt.Frame parent,  boolean modal){
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reader_ReturnJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Reader_ReturnJDialog dialog = new Reader_ReturnJDialog(new javax.swing.JFrame(), true);
